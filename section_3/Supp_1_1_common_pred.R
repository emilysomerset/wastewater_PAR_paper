...
for (j in 126){
  ...
  save(file=paste0("./section_3/results_pred_common/results_",j,".RData"), list = "MI_models")
}
...
# 
# save(file="./section_3/results_pred_popweighted/results_pred.RData", results_pred)
