...
load("./section_3/data/work_d.RData")
load("./section_3/data/work_d_toronto_2024_08_08.RData")

compile(file="./section_3/cpp/model_ospline_fixedeffects_daily_singleCOV_AR2_transformpaper_censored.cpp")
try(dyn.unload(dynlib("./section_3/cpp/model_ospline_fixedeffects_daily_singleCOV_AR2_transformpaper_censored")),silent = TRUE)
dyn.load(dynlib("./section_3/cpp/model_ospline_fixedeffects_daily_singleCOV_AR2_transformpaper_censored"))
...
save(file="./section_3/wastewater_model_ON_phachist.RData", list = c("samps1","marginals","tmbdat","df_full"))
...
save(file="./section_3/results_model_ON_phachist.RData", list = "results")
